...
class Splash {
  ...
  async startAnimation(){
    let splashes = [
      { "message": "Arrêtez de nous spam, ça arrive..", "author": "Nkz" },
      { "message": "Préparation à l'aventure !", "author": "IksReal" }
    ];
    if(localStorage.getItem("theme") == "white"){
      splashes.push(
        { "message": "Sponsorisé par le lobby du lait", "author": "0lixiz" }
      );
    }
